...
{
    use ImageUpload;
    private ExaminationRepositoryInterface $lectureRepository;

    public function __construct(ExaminationRepositoryInterface $lectureRepository)
    {
    ...
    {
        return view('examination.teacher');
    }
}
