...
{
    use ImageUpload;
    private TeacherReviewRepositoryInterface $teacherReviewRepository;

    public function __construct(TeacherReviewRepositoryInterface $teacherReviewRepository)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.teacher_review.index');
    }
