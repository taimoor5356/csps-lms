...
use App\Interfaces\StudentServicesRepositoryInterface;
use Carbon\Carbon;
use App\Models\User;
...
class StudentServicesRepository implements StudentServicesRepositoryInterface 
{
    public function showTableData($data, $trashed)
    {
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) use ($trashed) {
                ...
                if ($trashed == null) {
                    $btn .= '
                        <a href="lectures/'.$row->id.'/show" class="btn btn-success bg-success p-1 -view-student-detail" data-student-id="'. $row->id .'" title="View" data-toggle="modal" data-target="#modal-default"><i class="fa fa-eye"></i></a>
    ...
    public function getFulfilledStudentServices() 
    {
