...
class TeacherReviewRepository implements TeacherReviewRepositoryInterface 
{
    ...
    public function store($request) 
    {
        try {
            ...
            $teacherReview->name = $request->name;
            $teacherReview->course_id = $request->course_id;
            $teacherReview->comment = $request->comment;
            $teacherReview->review = $request->review;
            $teacherReview->created_by = Auth::user()->id;
            $teacherReview->save();
            DB::commit();
