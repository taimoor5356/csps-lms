        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex">
                    <h6>All Courses @if(!empty($userId))({{\App\Models\User::where('id', $userId)->first()->name}})@endif</h6>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    @include('enrollment._teachers_table')
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('enrollments.teachers', [$userId]) }}"
            },
            columns: [
                {
                    data: 'image',
