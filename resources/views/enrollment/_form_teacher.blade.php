...
<div class="row">
    <!-- <div class=" col-md-4">
        ...
        <div class="form-group">
            ...
            <input class="day mx-1" name="first_shift_day[]" type="radio" @isset($course) @if(\App\Models\CourseShift::where('course_id', $course->id)->where('shift_id', 1)->where('day_id', $day->id)->exists()) checked @endif @endisset
    ...
    <!-- <div class="offset-4 col-md-4">
        ...
        <div class="form-group">
            ...
            <br>
            @foreach(\App\Models\Day::get() as $day)
            <input class="day mx-1" name="second_shift_day[]" type="radio" @isset($course) @if(\App\Models\CourseShift::where('course_id', $course->id)->where('shift_id', 2)->where('day_id', $day->id)->exists()) checked @endif @endisset
                value="{{$day->id}}" onfocus="focused(this)"
                onfocusout="defocused(this)"> {{$day->name}}
                <br>
            @endforeach
