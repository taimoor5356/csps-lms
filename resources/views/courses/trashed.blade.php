...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white" aria-current="page"><a class="text-white" href="{{ route('courses') }}">Courses</a>
            </li>
            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex">
                    ...
                    <div class="header-buttons ms-auto text-end">
                        <a href="{{ route('courses') }}" class="btn btn-primary"><i class="fa fa-eye"></i> View All</a>
                    </div>
                </div>
