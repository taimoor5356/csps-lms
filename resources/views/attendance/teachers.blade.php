...
@endsection
@section('breadcrumbs')
    @include('layout.breadcrumb', ['institute_name' => 'CSPs', 'tab_name' => 'Users', 'page_title' => 'Teachers Attendance']);
@endsection
<!-- Section Body -->
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('attendances', ['teachers', $userId]) }}",
            },
            columns: [
                {
                    data: 'name',
