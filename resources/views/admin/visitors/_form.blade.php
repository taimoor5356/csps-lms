    ...
    <div class="admin-form row my-0 py-0">
        <div class="col-lg-6 col-md-6 my-0 py-0">
            <div class="form-group mb-3 my-0 py-0">
                ...
                <p><small class="text-danger">April 2nd, 2023 CSS/PMS 2024 free on campus seminar at 3:00pm</small></p>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 my-0 py-0">
            <div class="form-group mb-3 my-0 py-0">
                ...
                <p><small class="text-danger">April 1st, 2023 CSS/PMS 2024 free online seminar at 3:00pm</small></p>
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group mb-3">
                ...
                <select class="form-control domicile"
                    name="domicile" id="domicile" required>
