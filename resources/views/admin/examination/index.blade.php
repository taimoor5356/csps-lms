    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"><span
                    class="text-light">Examinations</span></li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Examinations</h6>
    </nav>
@endsection
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pb-2">
                    @include('admin.examination._table')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="modal-title-default">Examinations Detail</h6>
