    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"><span
                    class="text-light">Lectures</span></li>
        </ol>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="modal-title-default">lecture Detail</h6>
                        ...
                        <div class="container">
                            <div class="main-body">
                                <div class="row gutters-sm">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card mb-3 lecture-modal-card">
                                            <div class="card-body lecture-modal-card-body">
                                                <div class="row">
                                                    <div class="col-sm-3">
...
<script>
    $(document).ready(function() {
        ...
        // $(document).on('click', '.view-lecture-detail', function() {
        //     var _this = $(this);
        //     var lectureId = _this.attr('data-lecture-id');
        //     $.get('lectures/' + lectureId + '/show', function(data) {
        ...
        //         $('span.occupation').html(data.lecture_occupation);
        ...
        //         var url = '{{ asset('public/assets/img/lectures/:image') }}';
        ...
        //             $.post('lectures/' + lectureId + '/delete', {_token: '{{ csrf_token() }}'},function() {
        //             });
        //             Swal.fire({
        //                 title: 'Deleted!',
        ...
        //     });
        // });
        // Ends Open Delete lecture Modal
    });
</script>
<!-- Scripting Here -->
@endsection
