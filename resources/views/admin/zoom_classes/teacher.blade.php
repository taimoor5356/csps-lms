...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"><span class="text-light">Zoom Class</span>
            </li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Zoom Class</h6>
    </nav>
@endsection
                        ...
                        <div class="col-12">
                            <table class="table download-center-table">
                                <thead>
                                    ...
                                    <th class="px-0">Scheduled Status</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="px-0">Lecture#1</td>
                                        <td class="px-0">12/09/2022-05:30PM</td>
                                        <td class="px-0"><span class="text-white bg-warning p-1">Scheduled</span></td>
                                        <td class="px-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-0">Lecture#1</td>
                                        <td class="px-0">12/09/2022-05:30PM</td>
                                        <td class="px-0"><span class="text-white bg-success p-1">Hppening</span></td>
                                        <td class="px-0">
                                            <a href="#" class="btn btn-primary">Join</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="px-0">Lecture#1</td>
                                        <td class="px-0">12/09/2022-05:30PM</td>
                                        <td class="px-0"><span class="text-white bg-secondary p-1">Conducted</span></td>
                                        <td class="px-0">
                                            <a href="#" class="btn btn-primary">Join</a>
                                        </td>
                                    </tr>
