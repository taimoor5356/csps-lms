    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"><span
                    class="text-light">Zoom Classes</span></li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Zoom Classes</h6>
    </nav>
@endsection
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pb-2">
                    @include('admin.zoom_classes._table')
                </div>
            </div>
        </div>
    </div>
