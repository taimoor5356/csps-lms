...
<main class="main-content">
  <section style="align-content-middle">
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 mb-0">
                    <div class="card card-plain bg-white">
                        <div class="card-header pb-0 text-start">
                            ...
                            <span class="mb-0 text-sm">Enter your Name, Email and password to sign in</span>
                        </div>
                        <div class="card-body">
                            <form role="form" method="POST" action="#">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn btn-lg btn-primary btn-lg w-100 mt-2 mb-0 signin-btn">Sign in</button>
                                </div>
                            </form>
                        </div>
      ...
      <div class="row">
        <div class="col-12 d-flex justify-content-center">
            <ul class="d-inline-flex text-white login-social-icons">
                <li>
                    <center><a href="#" class="text-white"><i class="fa fa-whatsapp"></i></a></center>
                </li>
                <li>
                    <center><a href="https://www.facebook.com/CSPsAcademy" class="text-white"><i class="fa fa-facebook"></i></a></center>
                </li>
                <li>
                    <center><a href="https://www.instagram.com/cspsacademy" class="text-white"><i class="fa fa-instagram"></i></a></center>
                </li>
                <li>
                    <center><a href="https://twitter.com/CSPSAcademy" class="text-white"><i class="fa fa-twitter"></i></a></center>
                </li>
                <li>
                    <center><a href="https://www.youtube.com/c/CivilServicesPreparatorySchoolforCSSPMSAcademy" class="text-white"><i class="fa fa-youtube"></i></a></center>
                </li>
                <li>
                    <center><a href="https://t.me/cspsacademy" class="text-white"><i class="fa fa-telegram"></i></a></center>
                </li>
            </ul>
        </div>
    </div>
