...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"><span class="text-light">Revision Classes</span></li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Revision Classes</h6>
    </nav>
@endsection
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    @include('revision_classes._table')
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-4">
        <div class="modal fade" id="add-new-revision-class" tabindex="-1" role="dialog" aria-labelledby="add-new-revision-class"
            aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="{{ route('store.revision_classes') }}" method="POST">
                        @csrf
                        <div class="modal-header">
                            <h6 class="modal-title" id="modal-title-default">Revision Classes Details</h6>
