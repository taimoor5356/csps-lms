...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"><span class="text-light">Lecture Details</span>
            </li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Lecture Details</h6>
    </nav>
@endsection
