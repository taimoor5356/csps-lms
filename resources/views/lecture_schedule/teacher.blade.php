...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"><span class="text-light">Teacher Lecture Schedules</span></li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Teacher Lecture Schedules</h6>
    </nav>
@endsection
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex">
                    @php 
                        $teacherSchedule = $teacherLectureSchedules->first();
                    @endphp
                    <h6>Teacher Lecture Schedules (@isset($teacherSchedule->teacher->user){{$teacherSchedule->teacher->user->name}}@endisset)</h6>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    @include('lecture_schedule._teacher_schedule_table')
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('students_lecture_schedule', [1]) }}"
            },
            columns: [
                {
                    data: 'student_name',
