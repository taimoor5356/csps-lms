    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        ...
        @role('admin')
            <ul class="navbar-nav">
                ...
                @can('menu_view')
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('create-menus') ? 'active' : '' }}"
                            href="{{ url('create-menus') }}">
                            <div
                ...
                @can('users_view')
                    <li class="nav-item">
                        <a data-bs-toggle="collapse" href="#users"
                            class="nav-link collapsed {{ $admins || $teachers || $students || $visitors || $interviews ? 'active' : '' }}"
                            aria-controls="users" role="button" aria-expanded="false">
                            <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                                <i
                                    class="fa fa-users {{ $admins || $teachers || $students || $visitors || $interviews ? 'text-white' : 'text-primary' }} text-sm opacity-10"></i>
                            </div>
                            <span class="nav-link-text ms-1">Users</span>
                        </a>
                        <div class="collapse {{ $admins || $teachers || $students || $visitors || $interviews ? 'show' : '' }}"
                            id="users" style="">
                            <ul class="nav ms-4">
                                <li class="nav-item ">
                                    <a class="nav-link {{ (request()->is('admins') ? 'active' : request()->is('admins/create')) ? 'active' : '' }}"
                                        href="{{ route('admins') }}">
                ...
                <li class="nav-item mb-4">
                    <a data-bs-toggle="collapse" href="#setting" class="nav-link collapsed" aria-controls="setting"
                        role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="fa fa-user-clock text-primary text-sm opacity-10"></i>
                        </div>
        ...
        @role('teacher')
            <ul class="navbar-nav">
                <!-- Home -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('teachers/dashboard') ? 'active' : '' }}"
                        href="{{ url('teachers/dashboard') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                        </div>
                ...
                <!-- My Attendance -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('teachers/students/attendance') ? 'active' : '' }}"
                        href="{{ url('teachers/students/attendance') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Examination -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('teachers/examination') ? 'active' : '' }}"
                        href="{{ url('teachers/examination') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Examination -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('teachers/lesson-plan') ? 'active' : '' }}"
                        href="{{ url('teachers/lesson-plan') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Examination -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('teachers/academics') ? 'active' : '' }}"
                        href="{{ url('teachers/academics') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Examination -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('teachers/download-center') ? 'active' : '' }}"
                        href="{{ url('teachers/download-center') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Examination -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('teachers/assignments') ? 'active' : '' }}"
                        href="{{ url('teachers/assignments') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <!-- Examination -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('teachers/zoom-class') ? 'active' : '' }}"
                        href="{{ url('teachers/zoom-class') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @role('student')
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('lecture_schedule') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-minus text-primary text-sm opacity-10"></i>
                        </div>
